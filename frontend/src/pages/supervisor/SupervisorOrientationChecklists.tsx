...
export function SupervisorOrientationChecklists() {
  ...
  useEffect(() => {
    api
      .get<ChecklistRow[]>('/supervisor/orientation')
      .then(setRows)
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-slate-500">
            Orientation status for students assigned to you.
          </p>
        </div>
      ...
      <Card>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 px-4 pt-3">
          <div className="flex items-center gap-2 text-xs text-slate-500">
            ...
            <span className="ml-3 inline-block h-2 w-2 rounded-full bg-amber-500" /> 60–99%
            complete
            <span className="ml-3 inline-block h-2 w-2 rounded-full bg-slate-400" /> &lt; 60%
            complete
          </div>
        ...
        <div className="px-4 pb-4 pt-3">
          {loading ? (
            ...
            <DataTable
              ...
              data={filtered}
              keyField="id"
              emptyMessage="No orientation checklists submitted yet for your assigned students."
            />
          )}
        </div>
      </Card>
                        ...
                        >
                          ...
                          <p className="mt-0.5 text-[11px] text-slate-500">
                            {((sig as { date: string | null }).date &&
                              new Date(
                                (sig as { date: string | null }).date as string,
                              ).toLocaleDateString()) ||
                              'No date'}
                          </p>
                        </div>
