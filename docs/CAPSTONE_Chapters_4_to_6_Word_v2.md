...
**Figure 5.2 — Response time bar chart** *(optional: measure 10 page loads with DevTools Network tab)*
...
*(Attach your signed consent form and the task list given to participants.)*
